...
while True:
    instructions = input("Enter the instruction : ")
...
print("\n Pass1 machine code output without reference of the symbolic address : \n")
...
for i in range(len(l)):
    if "NEXT" in l[i]:
        for j in range(len(symbol)):
            if "NEXT" in symbol[j]:
                pos = j
                print("{} {} {} , {}".format(relativeAddress[i], l[i], machineCode[i], symbolValue[pos]))
    else:
        print("{} {} {}".format(relativeAddress[i], l[i], machineCode[i]))
...
# OUTPUT
# Enter the instruction : LOAD A
# Enter the instruction : ADD B
# Enter the instruction : JMP NEXT
# Enter the instruction : NEXT: MOV C, A
# Enter the instruction : SUB D
# Enter the instruction : JNZ NEXT
# Enter the instruction : HALT
