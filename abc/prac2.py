...
# output
# Enter the instruction or HALT to end the program: LOAD
# Enter address for LOAD(8byte): 01020304
# Enter the instruction or HALT to end the program: ADD
# Enter data for ADD(4byte): 1234
# Enter the instruction or HALT to end the program: STORE
# Enter address for STORE(8byte): 05060708
# Enter the instruction or HALT to end the program: HALT